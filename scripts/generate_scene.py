...
def main(argv):
    ...
    parser.add_argument(
        "--output_directory",
        default="/data/render_scene/scene-synth/livingroom/",
    ...
    processor = Processor(
        ...
        config_path='../config/bedroom_train_config.yaml',
        generator_type=args.generator_type,
        discriminator_type=args.discriminator_type,
        version='checkpoint_eval1000.tar',
        device=device
    )
    ...
    for i in range(args.n_sequences):
        ...
        while flag is False:
            ...
            flag = fp.load_furniture_from_data(data, num_class=23, num_each_class=4, thresholds=0.5)
            if flag is False:
                continue
